...
def main():
    ...
    ciphertext = """Ilr Qtjbtve Olbif jigt xugqc daa htlv eaf uzixb. Vpp upni qd llvvm hxxu hqgt gvtkwtw. Gjm nxvpnmd gictmdtrg vpp umig kzcxvpmyiw bh Iqgmpc, Idxe, Nwaegeyki, Pjvbrm lch Aqzew eaf Azjxu Cupgmpc. Bst gvtkwtw ntm maepm, jwji, ttmpc, vrf iys crntzl. Xug nwpk bh mgtvl ewfcxea qy ilr iixtw uca li prcae drr qn ewifg kzashta. Ewi zqbed ss vpp Dploxtrw vu 'Nlhxrt, ptvlrt, aegsaimc'."""
